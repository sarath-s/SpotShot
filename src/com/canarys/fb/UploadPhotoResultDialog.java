...
public class UploadPhotoResultDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      mUsefulTip = (TextView) findViewById(R.id.usefulTip);
        ...
        try {
          ...
          mUsefulTip.setText(String.valueOf(MainActivity.locationData+" "+MainActivity.latitude
    ...
    public void setLocation(){
    	 ...
    	 String relativePath = photo_id + "/place/" + Utility.userUID;
         Bundle params = new Bundle();
         params.putString("id", "1");
         params.putString(" name", "Banglore");
